...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // меню
    {
        ...
        sidebarMenu.addEventListener('click', e=>{
            ...
            if (target) {
                ...
                sidebarMenu.querySelectorAll('li').forEach((elem)=> {                    if (elem === parentTarget) {
    ...
    // API
    {
      const API_KEY = 'AIzaSyDaeFKgSfg5iFD8sm82_COHvpS2VbNael4';
      const CLIENT_ID = '188477056375-aipnkvgldshl1lu4hp1ucst5l5qhqdk0.apps.googleusercontent.com';
        //авторизация
        {
        ...
        //request
        {
            ...
            like.addEventListener('click', () => {
                request({
                    ...
                    part: 'snippet',
                    playlistId: 'LLmwrQB0jJ40NPB-V9ALNB3Q',
                    maxResults: 6,
                })
            });
